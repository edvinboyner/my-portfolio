...
import { useParams } from "react-router-dom"; // Take out sections of the URL that we need and use it accordingly
    ...
    return (
        <main className="bg-gray-200 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-gray-100 rounded-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-white bg-opacity-75 rounded p-12">
                            <h1 className="cursive text-3xl lg:text-4xl mb-4">{singlePost.title}</h1>
                ...
                <BlockContent //The text field in studio. We can style on the website
