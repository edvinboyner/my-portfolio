                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                   {postData && postData.map((post, index) => (
                    <article>
                        ...
                        <span className="block h-64 relative rounded-3xl shadow leading-snug border-l-8 border-gray-700" key={index}>
                            <img 
                            ...
                            <span className="block relative h-full flex justify-end items-end pr-4 pb-4">
                                <h3 className="text-gray-800 text-lg font-bold px-3 py-4 bg-gray-700 text-gray-900 hover:text-gray-400 bg-opacity-75 rounded">{post.title}</h3>
                            </span>
                        </span>
                        </Link>
                    </article>
