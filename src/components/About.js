...
export default function About(){
    ...
    return(
         <main className="relative">
             <img src={image} alt="Space" className="absolute w-full" />
             <div className="p-24 lg:pt-48 container mx-auto relative">
                 <section className="bg-gray-800 opacity-90 rounded-lg shadow-2xl lg:flex p-20">
                     <img src={urlFor(author.authorImage).url()} className="rounded w-32 h-32 lg:w-44 lg:h-64 mr-8" alt={author.name} />
                     <div className="text-lg flex flex-col justify-center">
                         <h1 className="cursive text-6xl text-gray-300 mb-4">Hey there. I'm {" "}
